		...
		<div id="page-wrapper">
			...
			<!-- Header -->
				<header id="header" class="masthead text-center text-white d-flex">
					<h1><a href="index.html">HTML</a> Tool kit Editor</h1>
					<nav id="nav">
						<ul>
			...
			<!-- 	<a href="login">  login  </a> -->
					<h2>The Best HTML Editor.</h2>
					<p>This free HTML WYSIWYG editor program allows you edit your source code online without <br>downloading any application. Guaranteed the best visual webpage builder software you can find out there!</p>
