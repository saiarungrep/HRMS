 ...
 --%>
	...
	<body class="landing">
		<div id="page-wrapper">
			...
			<!-- Banner -->
				<section id="banner">
					<h2>Marriage is a gift from god to us .
the quality of our marriage is our gift to him </h2>
					<ul class="actions">
						<li><a href="toolkit" class="button special">Html Editor</a></li>
						<li><a href="jsscript1" class="button special">UI Editor</a></li>
					<a href="js&css" class="button special">Js&Css Editor</a>	
			...
			<!-- Footer -->
				<footer id="footer">
					...
					<ul class="copyright">
						<li>&copy; Grepthor. All rights reserved.</li>
					</ul>
				</footer>
